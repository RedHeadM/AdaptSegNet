...
def main():
    ...
    for i_iter in range(args.num_steps):
        ...
        if i_iter%10==0 and i_iter:
            ...
            self.writer.add_scalar(f'train/{loss_seg_value1}', loss_seg_value1, i_iter)
            self.writer.add_scalar(f'train/{loss_seg_value2}', loss_seg_value2, i_iter)
            self.writer.add_scalar(f'train/{loss_adv_target_value1}', loss_adv_target_value1, i_iter)
            self.writer.add_scalar(f'train/{loss_D_value1}', loss_D_value1, i_iter)
            self.writer.add_scalar(f'train/{loss_D_value2}', loss_D_value2, i_iter)
